...
public class Devolucion
{
    ...
    public Devolucion(int id, int facturaID, int detalleFacturaID, int productoID, int cantidad, string motivo,
    ...
    [Required] public int DetalleFacturaID { get; set; }

    [Required] public int ProductoID { get; set; }

    [Required] public int Cantidad { get; set; }

    [Required] [StringLength(255)] public string Motivo { get; set; }
