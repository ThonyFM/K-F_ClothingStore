...
public class Descuento
{
    ...
    public Descuento(int id, string tipo, decimal valor, string descripcion, DateTime fechaInicio, DateTime? fechaFin,
        string estado)
    {
        ID = id;
        Tipo = tipo;
    ...
    [Required] [StringLength(50)] public string Tipo { get; set; }
