...
public class Proveedor
{
    ...
    public Proveedor(int id, string nombreEmpresa, string nombreContacto, string telefono, string email,
        int direccionID, string estado, string creadoPor)
    {
        ID = id;
    ...
    [Required] [StringLength(100)] public string NombreEmpresa { get; set; }

    [StringLength(100)] public string NombreContacto { get; set; }
