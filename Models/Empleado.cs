...
public class Empleado
{
    ...
    public Empleado(int id, int personaID, string puesto, DateTime fechaContratacion, decimal salario, string estado,
        string creadoPor)
    {
        ID = id;
        PersonaID = personaID;
    ...
    [Required] [StringLength(100)] public string Puesto { get; set; }

    [Required] public DateTime FechaContratacion { get; set; }
